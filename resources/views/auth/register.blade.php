            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="date_of_birth" class="col-md-2 col-form-label text-md-start">{{ __('Date of Birth') }}</label>
                            <div class="col-md-10">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <label for="id_verification" class="col-form-label text-md-end">{{ __('ID Verification') }}</label>
                                <input id="id_verification" type="file" class="form-control @error('id_verification') is-invalid @enderror" name="id_verification" value="{{ old('id_verification') }}" autocomplete="id_verification" autofocus>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <label for="id_verification" class="col-form-label text-md-end">{{ __('Password') }}</label>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <label for="id_verification" class="col-form-label text-md-end">{{ __('Confirm Password') }}</label>
